const home = () => {
  ...
  (function(){
    ...
    function dsAvatarUrl(ds){
      ...
      return (ds && ds.datasetAvatarUrl)
        ? ds.datasetAvatarUrl
        : "https://api.dicebear.com/8.x/shapes/svg?seed=" + encodeURIComponent(name);
    }
    ...
    function renderHead(kind){
      ...
      if(kind === "people"){
        ...
        thead.innerHTML =
          '<tr><th class="col-name">Dataset</th>' +
          '<th class="col-mid">Avg rating</th>' +
      ...
      datasets.forEach(function(ds){
        ...
        tr.innerHTML =
          '<td class="col-name">' +
            ...
            '</div>' +
          '</td>' +
          '<td class="col-mid">' + ratingCell + '</td>' +
          '<td class="col-actions"><a class="btn" href="/datasets/' +
            encodeURIComponent(ds.datasetId || ds._id) + '">Open</a></td>';
    ...
    function load(){
      ...
      apiGet(endpoint)
        .then(function(data){
          ...
          return renderAll(data.datasets || []);
        })
        .catch(function(err){
